	...
	<div class="product-section">
		<div class="container">
			<div class="product-section_header">
				<div class="section-title"><?= GetMessage('TQ_PRODUCTS_POPULAR_TITLE'); ?></div>
				<a href="<?= SITE_DIR ?>catalog/popular/"
				   class="main-btn_mod tablet-small_hidden"><?= GetMessage('TQ_PRODUCTS_POPULAR_ALL_PRODUCTS'); ?> <span
			...
			<div class="text-center tablet-small_visible">
				<a href="<?= SITE_DIR ?>catalog/"
				   class="main-btn_mod unified_mobile-btn"><?= GetMessage('TQ_PRODUCTS_POPULAR_ALL_PRODUCTS'); ?> <span
							class="ico-arrow"></span></a>
			</div>
		</div>
	</div>
