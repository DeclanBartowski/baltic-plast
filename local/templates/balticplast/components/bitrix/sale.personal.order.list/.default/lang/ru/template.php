<?
$MESS["SPOL_TPL_EMPTY_ORDER_LIST"] = "У вас нет активных покупок!";
...
$MESS["SPOL_TPL_TEXT_TO_CATALOG"] = "Перейдите в каталог, у нас много интересного";
...
$MESS["SPOL_TPL_ORDERS_HISTORY_HEADER"] = "История заказов";
$MESS["SPOL_TPL_ORDERS_CURRENT_HEADER"] = "Текущие заказы";
...
$MESS['TQ_ORDER_NAME'] = 'Название заказа';
$MESS['TQ_ORDER_DATE'] = 'Дата';
$MESS['TQ_ORDER_STATUS'] = 'Статус';
$MESS['TQ_ORDER_DISCOUNT_SUM'] = 'Общая скидка';
$MESS['TQ_ORDER_SUM'] = 'Сумма';
$MESS['TQ_ORDER_DOWNLOAD_BILL'] = 'Скачать счет';
$MESS['TQ_ORDER_CLOSE'] = 'Свернуть';
$MESS['TQ_ORDER_PRODUCT'] = 'Товар';
$MESS['TQ_ORDER_ARTNUMBER'] = 'Артикул';
$MESS['TQ_ORDER_QUANTITY'] = 'Количество';
$MESS['TQ_ORDER_DISCOUNT'] = 'Скидка';
$MESS['TQ_ORDER_PRICE'] = 'Цена';
$MESS['TQ_ORDER_CONSIST'] = 'Состав заказа';
$MESS['TQ_ORDER_PRODUCT_MEASURE'] = 'шт.';
$MESS['TQ_ORDER_CANCELED'] = 'Отменен';
?>