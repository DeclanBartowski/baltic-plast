...
<?
$GLOBALS['arrSolutionsCardFilter']['PROPERTY_PRODUCTS'] = $elementId;
$APPLICATION->IncludeComponent(
    "bitrix:news.list",
    "solutions",
    Array(
        ...
        "FILTER_NAME" => "arrSolutionsCardFilter",
        "HIDE_LINK_WHEN_NO_DETAIL" => "N",
        "IBLOCK_ID" => IBLOCK_SOLUTIONS_ID,
        ...
        "PROPERTY_CODE" => array(0 => "", 1 => "SLIDER",),
        "SET_BROWSER_TITLE" => "N",
        "SET_LAST_MODIFIED" => "N",
