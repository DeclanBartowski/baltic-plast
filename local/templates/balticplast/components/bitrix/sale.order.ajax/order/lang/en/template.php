...
$MESS['TQ_BASKET_IS_EMPTY'] = 'Your cart is empty';
$MESS['TQ_BASKET_MOVE_TO_CATALOG'] = 'Go to the directory, we have a lot of interesting things';
$MESS['TQ_BASKET_GO_TO_CATALOG'] = 'Go to directory';
$MESS['TQ_ORDER_TITLE'] = 'Invoice for payment #NUMBER# from #DATE#';
$MESS['TQ_ORDER_INPUT_LAST_NAME'] = 'Last Name';
$MESS['TQ_ORDER_INPUT_NAME'] = 'Name';
$MESS['TQ_ORDER_INPUT_SECOND_NAME'] = 'Middle name';
$MESS['TQ_ORDER_INPUT_EMAIL'] = 'Email';
$MESS['TQ_ORDER_INPUT_PHONE'] = 'Contact Phone';
$MESS['TQ_ORDER_INPUT_ORG_NAME'] = 'Organization Name';
...
$MESS['TQ_ORDER_INPUT_ADDRESS'] = 'Legal address of the company';
$MESS['TQ_ORDER_BUTTON'] = 'Checkout';
//$MESS['TQ_ORDER_TITLE'] = 'Checkout';
$MESS['TQ_ORDER_REQUISITES_TITLE'] = 'Requisites';
$MESS ['TQ_ORDER_CONFIRM_PRINT'] = 'Download account';
?>