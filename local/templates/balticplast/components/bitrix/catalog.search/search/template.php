...
$productsDeclension = new Declension(
    GetMessage('CT_BCSE_PRODUCTS_DECL_ONE'),
    GetMessage('CT_BCSE_PRODUCTS_DECL_TWO'),
    GetMessage('CT_BCSE_PRODUCTS_DECL_MORE')
);
?>
	...
	<div class="container">
        ...
        if (Loader::includeModule('search')) {
            ...
            foreach ($arElements as $arElement) {
                if (strripos($arElement, 'S') === false) {
                    $intElementsCount++;
                }
            }
            ?>
			<div class="search_top-panel">
				<div class="section-title"><?= GetMessage('CT_BCSE_TITLE'); ?></div>
				<span class="number-goods"><?= GetMessage('CT_BCSE_ELEMENT_COUNT', [
                        '#COUNT#' => sprintf('%s %s', $intElementsCount, $productsDeclension->get($intElementsCount))
                    ]) ?>
				</span>
			</div>
            <?
            if (!empty($arElements) && is_array($arElements)) {
                ...
                if (is_array($arElements)) {
                    ?>
					<div class="no-search_results">
						<span class="ico-search no-search_icon"></span>
						<div class="main-title"><?= GetMessage('CT_BCSE_NOT_FOUND'); ?></div>
						<p><?= GetMessage('CT_BCSE_TRY_ANOTHER'); ?></p>
                        <?= GetMessage('CT_BCSE_LINK_TO_CATALOG', ['#LINK#' => SITE_DIR . 'catalog/']) ?>
					</div>
                    <?
                    return;
                }
